...
export class ArcballCamera {
    constructor(eye, center, up, zoomSpeed, screenDims) {
        ...
        var rotMat = mat3.fromValues(xAxis[0],
            xAxis[1],
            xAxis[2],
            yAxis[0],
            yAxis[1],
    ...
    zoom(amount) {
        var vt =
            vec3.set(vec3.create(), 0.0, 0.0, amount * this.invScreen[1] * this.zoomSpeed);
        var t = mat4.fromTranslation(mat4.create(), vt);
        this.translation = mat4.mul(this.translation, t, this.translation);
        if (this.translation[14] >= -1) {
            this.translation[14] = -1;
        }
        this.updateCameraMatrix();
    }
    ...
    pan(mouseDelta) {
        ...
        this.centerTranslation =
            mat4.mul(this.centerTranslation, translation, this.centerTranslation);
        this.updateCameraMatrix();
    }
